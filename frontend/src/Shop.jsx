...
function Shop() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setSideProducts(res.data.slice(0, 5));
      })
      .catch((err) => console.log(err));
  }, []);
  ...
  useEffect(() => {
    ...
    if (selectedCategory) {
      filtered = filtered.filter(
        (prod) => prod.category_name === selectedCategory
      );
    }
  ...
  }, [allProducts, searchTerm, selectedCategory, currentPage, limit]);
            ...
            <div className="col-lg-3">
              <div className="row g-4">
                <div className="col-lg-12">
                  <h4>Categories</h4>
                  <ul className="list-unstyled fruit-categories">
                    {categories.map((cat, index) => (
                      <li key={index}>
                        <div
                          className="d-flex justify-content-between fruit-name"
                    ...
                    <li>
                      <div
                        className="d-flex justify-content-between fruit-name text-primary"
                ...
                {products.length > 0 ? (
                  ...
                  <div className="col-12">
                    <p className="text-center text-danger">
                      No products found for "{selectedCategory || searchTerm}"
                    </p>
                  </div>
                )}
